...
var $author$project$Picshare$saveComment = function (photo) {
	var newComment = $elm$core$String$trim(photo.newComment);
	return (newComment === '') ? photo : _Utils_update(
		photo,
		{
			comments: _Utils_ap(
				photo.comments,
...
var $author$project$Picshare$updateFeed = F2(
	function (fn, photo) {
		return A2($elm$core$Maybe$map, fn, photo);
	});
			...
			case 'SaveComment':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							photo: A2($author$project$Picshare$updateFeed, $author$project$Picshare$saveComment, model.photo)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateComment':
				var comment = msg.a;
...
var $author$project$Picshare$viewLoveButtion = function (_v0) {
	var liked = _v0.liked;
	var buttonClass = liked ? 'fa-heart' : 'fa-heart-o';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Picshare$viewLoveButtion(model),
						A2(
						$elm$html$Html$h2,
						_List_fromArray(
							[
